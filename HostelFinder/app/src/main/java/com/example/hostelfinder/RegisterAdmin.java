    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent(RegisterAdmin.this, LoginAdmin.class);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog = new ProgressDialog(RegisterAdmin.this);
                ...
                if (TextUtils.isEmpty(str_username) || TextUtils.isEmpty(str_fullname) || TextUtils.isEmpty(str_email) || TextUtils.isEmpty(str_phone) || TextUtils.isEmpty(str_password)) {
                    ...
                    dialog.dismiss();
                    Toast.makeText(RegisterAdmin.this, "Password must have 6 characters", Toast.LENGTH_SHORT).show();
                } else {
        ...
        firebaseAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(RegisterAdmin.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful())
                        {
                            ...
                            reference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    {
                                        dialog.dismiss();
                                        Intent intent =new Intent(RegisterAdmin.this, AdminMainActivity.class);
                        ...
                        {
                            dialog.dismiss();
                            Toast.makeText(RegisterAdmin.this, "You can't register with this email or password", Toast.LENGTH_SHORT).show();
                        }
